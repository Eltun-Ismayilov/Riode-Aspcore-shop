...
namespace Riode.WebUI.Migrations
{
    ...
    [Migration("20211014200418_blogpostComment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Riode.WebUI.Model.Entity.BlogComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Riode.WebUI.Model.Entity.Membership.RiodeRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Riode.WebUI.Model.Entity.BlogComment", b =>
                {
                    b.HasOne("Riode.WebUI.Model.Entity.Blog", "BlogPost")
                        .WithMany()
                        .HasForeignKey("BlogPostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Riode.WebUI.Model.Entity.BlogComment", "Parent")
                        .WithMany("Children")
